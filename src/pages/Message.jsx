  ...
  return (
    <div className="w-screen h-screen flex justify-around py-9">
      ...
      <div className="w-full h-full">
        {chatdata && (
          <div className=" w-full h-full shadow-xl rounded-[20px] ml-5 mr-5 px-[20px] ">
                ...
                <div className="mt-5 flex gap-5 items-center">
                  <div className="w-[95%] h-[45px] relative">
                    ...
                    <div className="flex gap-3 ">
                      <MdOutlineEmojiEmotions className="text-[20px] absolute top-[50%] right-[70px] translate-y-[-50%] text-black/25 " />
                      {/* <div className="absolute top-[-300px] right-[200px]">
                      <EmojiPicker onEmojiClick={handleEmoji}/>
                    </div> */}
                      <IoCameraOutline className="text-[20px] absolute top-[50%] right-[40px] translate-y-[-50%] text-black/25 " />
                    </div>
                  </div>
